...
module.exports = class extends Event {
  ...
  async run(client, old, msg) {
    ...
    let followMessage = `**${msg.channel.name}**\n${msg.content}`;
    ...
    for (let follower of followers) {
      ...
      follower.messages[follower.messages.findIndex(x=>x.reference.messageId == msg.id)] = { ...sentMessage, reference: message.reference };
